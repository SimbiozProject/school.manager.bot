package com.example.telegramBot.student.keyboards;
...
public class StudentInlineKeyboardSource {
    ...
    public InlineKeyboardMarkup getSchedule() {
        ...
        InlineKeyboardButton thirdButton = new InlineKeyboardButton().setText("Вернуться в главное меню").setCallbackData("menu");
    ...
    public InlineKeyboardMarkup getHomework() {
        return null;    // todo здесь находиться окно 42
    }

    public InlineKeyboardMarkup getCommunity() {
        InlineKeyboardMarkup inlineKeyboardMarkup = new InlineKeyboardMarkup();
        InlineKeyboardButton firstButton = new InlineKeyboardButton().setUrl("https://t.me/Jis6").setCallbackData("community");
        List<InlineKeyboardButton> firstButtonRow = new ArrayList<>();
        firstButtonRow.add(firstButton);
        List<List<InlineKeyboardButton>> keyboardRow = new ArrayList<>();
        keyboardRow.add(firstButtonRow);
    ...
    public InlineKeyboardMarkup getPay() {
        return null;// todo здесь находиться окно 41
    }
    ...
    public InlineKeyboardMarkup getAllSchedule() {
        return null;// todo здесь находиться окно 41
    }
