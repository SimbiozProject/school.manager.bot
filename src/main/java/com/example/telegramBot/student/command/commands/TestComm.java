...
//todo добавить верям на выполение теста, записать куда-то выбранные ответы (как?), сравнить их с базой правильных,
// посчитать процент и вывести его на экран вместе с RESALT и отправить на e-mail или в бот преподавателю.
// ДОбавить кнопку Reply "ВЕрнуться в гланое меню"
